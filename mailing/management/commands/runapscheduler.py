...
from services import automatic_mailing
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            ...
            id="automatic_mailing",  # Идентификатор, присвоенный каждому заданию, ДОЛЖЕН быть уникальным.
            max_instances=1,
            replace_existing=True,
        )
        logger.info("Added job 'automatic_mailing'.")
